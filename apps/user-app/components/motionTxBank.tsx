            ...
            {OnRampsortedTxns.map((tx: any, index: any) => {
              return (
                <div key={index} className="flex justify-between py-3">
                  <div>
                    <div className="text-md font-semibold">Received INR</div>
                    ...
                    <div
                      className={`text-xs mt-1 font-semibold ${getStatusStyle(tx.status)}`}
                    >
                      {tx.status}
                    </div>
                  </div>
          ...
          <div className="pt-2">
            {OffRampsortedTxns.map((tx: any, index: any) => {
              return (
                <div key={index} className="flex justify-between py-3">
                  <div>
                    <div className="text-md font-semibold">Sent INR</div>
