    ...
    <div className="bg-[#faf3f4]">
      <div className=" w-full srcoll-smooth overflow-y-hidden relative">
        <div className="bg-[#DEEFFF] m-auto font-normal p-5 text-3xl w-[90%] h-[20rem] md:w-[70%] md:text-8xl md:h-[700px] md:p-24 md:ml-24 md:mr-[316px] mt-24 rounded-[2rem]">
          <div className="md:w-[50%] h-[100%] flex flex-col justify-around items-center md:justify-between ">
            ...
            <p className="md:text-[1.7rem] text-xl md:text-left text-center  font-light">
              Pay, get paid, grow a business, and more. Join the tens of
              millions of people on Venmo.
            </p>
            <button
              id="vaultbtn"
              className="bg-[#008cff] w-[35%] text-base font-bold text-white rounded-3xl shadow-[10px_10px_0px_rgba(175,80,220,0.7)] hover:shadow-none md:w-[35%] py-3 transition-all duration-300 hover:bg-[#0f3554] hover:translate-x-[10px] hover:translate-y-[10px]"
            >
              Get Vault
            </button>
          </div>
      ...
      <div className="md:p-20 p-7 md:mt-64 mt-32 items-center flex md:flex-row flex-col space-y-5 ">
        ...
        <div className=" flex flex-col items-center justify-evenly md:ml-28 md:w-[40%] md:h-[500px] md:ml-25">
          ...
          <p className="md:text-xl hidden md:block text-sm font-light">
            Just like sending money to friends, you can use Venmo to checkout at
            some of your favorite brands in-stores and online. Now getting
            repaid for last night’s dinner can cover this morning’s latte.
          </p>
          <p className="md:text-xl hidden md:block text-sm font-light">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt
            laudantium quia at eos voluptates itaque velit. Dignissimos
            obcaecati placeat error. Exercitationem totam facilis explicabo
            voluptatum. Vel fugiat voluptatem asperiores unde?
          </p>
        </div>

        <p className="md:text-xl md:hidden text-sm font-light">
          Just like sending money to friends, you can use Venmo to checkout at
          some of your favorite brands in-stores and online. Now getting repaid
          for last night’s dinner can cover this morning’s latte.
        </p>
        <p className="md:text-xl md:hidden text-sm font-light">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt
          laudantium quia at eos voluptates itaque velit. Dignissimos obcaecati
          placeat error. Exercitationem totam facilis explicabo voluptatum. Vel
          fugiat voluptatem asperiores unde?
        </p>
      </div>
